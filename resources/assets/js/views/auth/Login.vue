<template>
    <div class="login" id="login">
        ...
        <div class="log-email">
            ...
            <a href="javascript:;" class="log-btn" @click="login('form')">登录</a>
        </div>
...
<script>
    ...
    import {setUser, setToken} from '../../plugins/auth/auth'
    export default {
        name: 'Login',
        data(){
            return {
...
<style scoped>
    ...
    .log-btn{width:356px;float: right; display: block; text-align: left; line-height: 50px;margin:0 auto 15px; height:50px; color:#fff; font-size:13px;-webkit-border-radius: 5px; background-color: #3B5999;
        -moz-border-radius: 5px;
        -ms-border-radius: 5px;
        -o-border-radius: 5px;
        border-radius: 5px;
    ...
    .log-email{text-align: center; margin-top: 20px; width: 90%;}
