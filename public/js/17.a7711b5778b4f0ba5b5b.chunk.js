...
throw new Error("Cannot find module \"@/plugins/auth\"");
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    data: function data() {
        return {
            headers: {
                Authorization: Object(__WEBPACK_IMPORTED_MODULE_1__plugins_auth__["getToken"])().token_type + ' ' + Object(__WEBPACK_IMPORTED_MODULE_1__plugins_auth__["getToken"])().access_token
            },
            limit: 1,
            form: {
                name: '',
    ...
    methods: {
        ...
        handleImagePreview: function handleImagePreview(file) {
            this.$alert('<img src="' + file.response.data + '">', '', {
