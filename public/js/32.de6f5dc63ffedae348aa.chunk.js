...
var __vue_styles__ = injectStyle
/* scopeId */
var __vue_scopeId__ = "data-v-37df191f"
/* moduleIdentifier (server only) */
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  __vue_script__,
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(17)("10b2a67e", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../../../../node_modules/css-loader/index.js!../../../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-37df191f\",\"scoped\":true,\"hasInlineConfig\":true}!../../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./index.vue", function() {
     var newContent = require("!!../../../../../../node_modules/css-loader/index.js!../../../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-37df191f\",\"scoped\":true,\"hasInlineConfig\":true}!../../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./index.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
        ...
        [
          _c(
            ...
            [
                ...
                scopedSlots: _vm._u([
                  {
                    ...
                    fn: function(scope) {
                      return [
                        _c("img", {
                          staticClass: "avatar",
                          attrs: { src: scope.user.avatar, alt: "avatar" }
                        })
                      ]
                    }
                  }
              ...
              _vm._v(" "),
              _c("el-table-column", {
                attrs: { property: "type", label: "评论类型" }
              }),
              _vm._v(" "),
              _c("el-table-column", {
                attrs: { property: "commentable", label: "评论标题" }
              }),
              _vm._v(" "),
              _c("el-table-column", {
                attrs: { property: "created_at", label: "评论时间" }
              }),
              _vm._v(" "),
              _c("el-table-column", {
                attrs: { label: "操作" },
                    ...
                    fn: function(scope) {
                      return [
                        _c(
                          "router-link",
                          {
                            attrs: { to: "comment/" + scope.row.id + "/edit" }
                          },
                          [
                            _c("el-button", {
                              attrs: {
