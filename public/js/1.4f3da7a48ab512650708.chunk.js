...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(6)("6678c416", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_cropperjs__ = __webpack_require__(143);
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    mounted: function mounted() {
        ...
        this.cropper = new __WEBPACK_IMPORTED_MODULE_1_cropperjs__["a" /* default */](img, {
            dragMode: 'move',
            preview: '#preview',
            restore: false,
            center: false,
                ...
                [
                  ...
                  _c(
                    ...
                    [
                      ...
                      _c(
                        "FormItem",
                        { attrs: { label: "封面", prop: "category_id" } },
                        [
                          _c("input", {
