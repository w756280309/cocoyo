...
var update = __webpack_require__(26)("e0ed1d90", content, false);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__Loading_vue__ = __webpack_require__(1016);
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(26)("b6275068", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
