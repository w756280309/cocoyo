...
var update = __webpack_require__(17)("e0ed1d90", content, false);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__Loading_vue__ = __webpack_require__(1164);
    ...
    methods: {
        ...
        toLogin: function toLogin() {
            ...
            this.$http.post('login', this.form).then(function (response) {
                ...
                Object(__WEBPACK_IMPORTED_MODULE_1__plugins_auth_auth__["d" /* setToken */])(response.data.token);
                Object(__WEBPACK_IMPORTED_MODULE_1__plugins_auth_auth__["e" /* setUser */])(response.data.user);
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(17)("b6275068", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
