...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    created: function created() {
        ...
        this.$http.get('dashboard/users').then(function (response) {
            _this.loading = false;
    ...
    methods: {
        ...
        changePage: function changePage(currentPage) {
            ...
            this.$http.get('users?page=' + currentPage).then(function (response) {
