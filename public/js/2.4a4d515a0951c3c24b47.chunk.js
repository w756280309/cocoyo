...
/* scopeId */
var __vue_scopeId__ = "data-v-c6d42b66"
...
Component.options.__file = "resources\\assets\\js\\views\\dashboard\\comments\\edit.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-c6d42b66", Component.options)
  } else {
    hotAPI.reload("data-v-c6d42b66", Component.options)
  }
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(3)("45ea3e8a", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../../../../node_modules/css-loader/index.js!../../../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-c6d42b66\",\"scoped\":true,\"hasInlineConfig\":true}!../../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./edit.vue", function() {
     var newContent = require("!!../../../../../../node_modules/css-loader/index.js!../../../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-c6d42b66\",\"scoped\":true,\"hasInlineConfig\":true}!../../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./edit.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    created: function created() {
        ...
        this.$http.get('comments/' + this.$route.params.id + '/edit').then(function (response) {
    ...
    methods: {
        onSubmit: function onSubmit(name) {
            ...
            if (this.form.content_raw) {
                this.$http.put('comments/' + this.$route.params.id, this.form).then(function (response) {
                    _this2.$Notice.success({
                        title: '编辑评论成功'
                    });
                    _this2.$router.push('/comments');
                });
            } else {
                  ...
                  _c(
                    ...
                    [
                      _c("markdown-editor", {
                        ...
                        model: {
                          value: _vm.form.content_raw,
                          callback: function($$v) {
                            _vm.$set(_vm.form, "content_raw", $$v)
                          },
                          expression: "form.content_raw"
                        }
                      }),
                      _vm._v(" "),
                      _c(
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-c6d42b66", module.exports)
  }
}
